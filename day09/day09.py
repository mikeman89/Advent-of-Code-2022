...
def main() -> None:
    ...
    for direction, distance in moves:
        for _ in range(distance):
            ...
            tail1.add_to_history()
            tail2.add_to_history()
            tail3.add_to_history()
            tail4.add_to_history()
            tail5.add_to_history()
            tail6.add_to_history()
            tail7.add_to_history()
            tail8.add_to_history()
